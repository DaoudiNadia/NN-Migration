...
from metamodel.nn import NN
from generators import GeneratorInterface
from generators.nn.pytorch.utils_pytorch import adjust_actv_func_name
from generators.nn.utils_nn import handle_layer, handle_tensorop, \
    add_in_out_var_to_subnn

if TYPE_CHECKING:
    from generators.nn.tf.utils_tf import  SetupLayerTF
    from generators.nn.pytorch.utils_pytorch import SetupLayerTorch
